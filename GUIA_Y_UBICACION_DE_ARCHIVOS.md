...
## ⚙️ 2. Scripts Principales del Pipeline ETL

| Script | Descripción | Documentación Asociada |
|---|---|---|
| 📄 **[pipeline_limpieza.py](file:///c:/Proyectos%20Pyhton/detallados/revision-detallado/pipeline_limpieza.py)** | Pipeline principal de limpieza de reportes detallados por CTR. Filtra hojas visibles (`sheet.visible`), aplica dual-row headers, FillDown horizontal, turnos A/B y clave única. | 📘 **[handoff_detallados.md](file:///c:/Proyectos%20Pyhton/detallados/revision-detallado/docs/handoff_detallados.md)**<br>📘 **[logica_m_campos_detallados.md](file:///c:/Proyectos%20Pyhton/detallados/revision-detallado/docs/logica_m_campos_detallados.md)**<br>📘 **[replicacion_detallada_detallados.md](file:///c:/Proyectos%20Pyhton/detallados/revision-detallado/docs/replicacion_detallada_detallados.md)** |
...
| 📄 **[01_Control_Interno_ETL/matriz_comparativa_metrajes.py](file:///c:/Proyectos%20Pyhton/detallados/revision-detallado/01_Control_Interno_ETL/matriz_comparativa_metrajes.py)** | Cruza Detallados vs Control Interno por clave única de turno y genera el informe de discrepancias. | 📘 **[analisis_discrepancias_metrajes.md](file:///c:/Proyectos%20Pyhton/detallados/revision-detallado/01_Control_Interno_ETL/analisis_discrepancias_metrajes.md)** |
