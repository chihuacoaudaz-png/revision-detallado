...
for ctr_name, filepath in detailed_files:
    ...
    for sheet_name in wb.sheet_names:
        ...
        # Data grid starts at index 24 (Excel Row 25)
        grid_rows = rows[24:]
        ...
        for r in grid_rows:
            ...
            if current_date not in date_seq_counter:
                date_seq_counter[current_date] = 0
            date_seq_counter[current_date] += 1
            ...
            # TURN ASSIGNMENT ON RAW GRID (BEFORE FILTERING):
            # 1. Special AMERICANA case:
            ...
            # NOW filter operational rows (keep if metraje > 0 or valid hasta/desde)
            has_met = metraje > 0
...
# Normalize CUCULII -> CUCULI in CI for fair comparison
